...
3. **If no parameters provided**:
   - List the contents of `docs/handoffs/` to discover available handoffs
   - Present a summary of what's available (directories for tickets, standalone handoff files)
   - Respond with:

   I'll help you resume work from a handoff document. Here are the available handoffs:

   [list of handoffs found]

   Which handoff would you like to resume from?

   Tip: You can invoke this command directly with a handoff path:
   `/rpiv:resume docs/handoffs/YYYY-MM-DD_HH-MM-SS_description.md`

   Or using a ticket number to resume from the most recent handoff for that ticket:
   `/rpiv:resume TICKET-NUM`
...
## Example Interaction Flow
    ...
    User: /rpiv:resume docs/handoffs/2025-01-08_13-44-55_create-context-compaction.md
    ...
    Shall I proceed with implementing the webhook validation fix,
    or would you like to adjust the approach?
