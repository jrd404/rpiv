...
func main() {
	rootCmd := &cobra.Command{
		...
		Long: `rpiv is a CLI for deploying the research-plan-implement-validate
framework and other Claude Code plugins to any project.

It embeds all plugin assets (skills, agents, hooks) into a single
